...
public class wGUI extends JFrame {
	...
	public wGUI() throws IOException {
		...
		westBar.setPreferredSize(new Dimension(400, 0));
		container.add(westBar, BorderLayout.WEST);
		
		JPanel eastBar = new JPanel();
		eastBar.setPreferredSize(new Dimension(400, 0));
		container.add(eastBar, BorderLayout.EAST);
